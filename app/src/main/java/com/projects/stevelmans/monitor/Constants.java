...
final class Constants {
    ...
    static final String QUOTA_STORAGE_MAX = "max quota";
    static final int DEFAULT_MAX_QUOTA = 60;
    static final String DEFAULT_PASSWORD = "password";
    static final String PASSWORD_STORAGE_NAME = "password";
    ...
    static final String QUOTA_EXTRA_VALUE = "quote extra value";
